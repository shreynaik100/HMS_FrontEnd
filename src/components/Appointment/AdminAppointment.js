...
function AdminAppointment() {
    ...
    const addAppointmentFormSubmitted = async (event) => {
        ...
        let response = await axios.put(`${process.env.REACT_APP_SERVER_URL}/appointments/`,
            reqObj,
            {
                headers: {
    ...
    const getAvailableSlots = async () => {
        ...
        if (doctorSelected) {
            let response = await axios.post(`${process.env.REACT_APP_SERVER_URL}/appointments`,
                {
    ...
    const deleteBookedSlots = async (appId) => {
        ...
        let response = await axios.delete(`${process.env.REACT_APP_SERVER_URL}/appointments/`,
            {
                headers: {
                    authorization: `Bearer ${localStorage.getItem("token")}`,
                },
    ...
    const getDoctorList = async () => {
        let response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/doctors`,
            {
                headers: {
                    authorization: `Bearer ${localStorage.getItem("token")}`
                }
    ...
    const getDepartmentList = async () => {
        let response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/departments`,
            {
                headers: {
                    authorization: `Bearer ${localStorage.getItem("token")}`
                }
    ...
    const getPatients = async () => {
        const response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/patients`);
    ...
    const handleCreateSlotSubmit = async (event) => {
        ...
        if (!(timeSlots.length > 0)) {
            ...
            // console.log(slot);
            try {
                let response = await axios.post(`${process.env.REACT_APP_SERVER_URL}/appointments/add`,
                    {
