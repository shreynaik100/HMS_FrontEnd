...
function DoctorProfile() {
    ...
    const getdoctorById = async () => {
        ...
        const response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/profile/doctor/`+doctorUserId);
    ...
    const updatedoctoruser = async (e) => {
        ...
        try {
            await axios.patch(`${process.env.REACT_APP_SERVER_URL}/profile/doctor/${doctorId}`, {
                firstName,
                lastName,
                username,
                email,
