...
function PatientProfile() {
  ...
  const getPatientById = async () => {
    ...
    const response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/profile/patient/${patientUserId}`);
  ...
  const updatePatient = async (e) => {
    e.preventDefault();
    try {
      await axios.patch(`${process.env.REACT_APP_SERVER_URL}/patients/${patientId}`, {
        firstName,
        lastName,
        username,
        email,
